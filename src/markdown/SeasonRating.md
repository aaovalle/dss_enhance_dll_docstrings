...
This property returns the rating for the current season (in Amps)&nbsp; if the SeasonalRatings option is active.
...
% gets the rating for the current season that applies to the active line

mySeasonRat = DSSLines.SeasonRating;
