...
This property sets/gets the assumed percent error in the Sensor measurement. Default is 1.
...
% gets the % error assumed for the active sensor

myPctError = DSSSensors.PctError;
