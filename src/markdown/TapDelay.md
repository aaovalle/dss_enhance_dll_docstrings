...
This property sets/gets the time delay \[s\] for subsequent tap changes in a set. Control may reset before actually changing taps.
...
% Gets the tap delay (s) of the active RegControl

myTapDelay = DSSRegCtrls.TapDelay;
