...
This property returns a variant array of strings containing names of all Line elements.
...
% gets the names of all Lines in the model

myLines = DSSLines.AllNames;
