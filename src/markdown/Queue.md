...
This property returns a variant array of strings containing the entire queue in CSV format.&nbsp;
...
% Gets all the control actions in the queue

myQueue = DSSCtrlQueue.Queue;
