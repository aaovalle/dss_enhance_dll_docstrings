...
This property returns a variant array of strings containing names of all ISOURCE elements.
...
% gets the names of all Isources in the model

myIsources = DSSIsources.AllNames;
