...
This interface can be used to gain access to the features of the active class without having to use a specific interface. This interface is embedded within the ActiveCircuit interface, requiring the definition of this interface before getting access the to ActiveClass interface.
