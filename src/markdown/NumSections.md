...
This property gets the number of feeder sections in the active meter's zone.
...
% gets the number of sections in the area of the active EM

myNSections = DSSMeters.NumSections;
