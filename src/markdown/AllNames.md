...
This property returns the names for all the objects defined within the active class. The names are returned as an array of string.
...
myloads = DSSActiveClass.AllNames;
