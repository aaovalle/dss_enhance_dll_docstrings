...
This property returns the total Number of customers in this zone (down-line from the active EnergyMeter).
...
% gets the total number of customers within the active EM zone

myNCust = DSSMeters.TotalCustomers;
