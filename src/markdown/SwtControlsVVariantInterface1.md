...
void SwtControlsV(int32\_t Parameter, uintptr\_t \*Pointer, int32\_t \*Type, int32\_t \*Size);
...
This parameter returns a pointer to an array of bytes containing the names of all the existing SwtControls in the project. Each string is separated by a NULL (0) character.
