...
This property gets the number of customers in the area of the active EnergyMeter.
...
% gets the number of customers in the area of the active EM

myNCustomers = DSSMeters.NumSectionCustomers;
