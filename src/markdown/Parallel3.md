...
This property gets/sets the flag indicating&nbsp; whether Rmatrix and Xmatrix are to be considered in parallel for the active reactor in the active circuit.
...
disp('X and R are in parallel');

else

disp('X and R are in series');
