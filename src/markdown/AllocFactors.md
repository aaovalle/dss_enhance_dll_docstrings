...
This property sets/gets an array of doubles to specify the phase allocation factors for the active meter.
...
% gets the allocation factors for the active EM

myAF = DSSMeters.AllocFactors;
