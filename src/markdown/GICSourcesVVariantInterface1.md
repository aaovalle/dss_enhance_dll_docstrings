...
void GICSourcesV(int32\_t Parameter, uintptr\_t \*Pointer, int32\_t \*Type, int32\_t \*Size);
...
### Parameter 0: GICSources.AllNames

This parameter returns a pointer to an array of strings with the GICSource names. Each string is separated by a NULL (0) character.
