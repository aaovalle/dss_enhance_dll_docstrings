...
This method forces the active Meter to take a sample. Use it when no automatic sampling routines take place, like for example, when using snapshot solution mode.
...
% forces the active EM to take a sample
