...
This property returns the&nbsp; time required to perform the latest solution (microseconds).
...
disp(\['time required for performing the last solution (us): ', num2str(DSSSolution.Process\_Time)\])
