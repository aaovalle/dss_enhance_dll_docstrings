...
This property returns the number of Circuit Elements in the model.
...
% Returns the number of circuit elements in the model

NCktElem = DSSCircuit.NumCktElements;
