...
This property sets/gets the name of metered element for the active EnergyMeter.
...
% gets the name of the metered element by the active EM

myElement = DSSMeters.MeteredElement;
