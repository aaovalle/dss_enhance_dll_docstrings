...
This property returns the SAIFI for the active meter's zone. Execute DoReliabilityCalc first.
...
% gets the SAIFI for the active EnergyMeter's zone

mySAIFI = DSSMeters.SAIFI;
