...
This interface can be used to gain access to the simulation/environment settings. This interface is embedded within the ActiveCircuit interface, requiring the definition of this interface before getting access the to Settings interface.
